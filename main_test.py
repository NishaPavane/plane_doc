...
class Plane():
    ...
    def mission_add_takeoff(self, takeoff_altitude=100, takeoff_pitch=20, heading=None):
    ...
    def arm_and_takeoff(self, altitude=100, pitch_deg=17.5):
    ...
    def set_waypoints_and_start_mission(self):
        waypoints = [
            (37.7749, -122.4194, 200),  # Example waypoint 1
            (37.7750, -122.4195, 200),  # Example waypoint 2
            (37.7751, -122.4196, 200),  # Example waypoint 3
        ]
        ...
        for wp in waypoints:
            ...
            waypoint = Command(0, 0, 0, 3, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, 37.7749, -122.4194, 200)
